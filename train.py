...
if __name__ == '__main__':
    logging.basicConfig(filename=os.path.join(root_path, "log2.txt"), level=logging.INFO,
    ...
    for project in ['appium','docker', 'dl4j','gitter', 'typescript','angular']:
        ...
        train_address = os.path.join(
            root_path, 'data/Deduplicated', project+'_train.json')
